    ...
    class Program
    {
        ...
        void addPoolAndLanes()
        {
            ...
            try
            {
                ...
                Pool pool = new Pool(Convert.ToDateTime("08:00:00"), Convert.ToDateTime("14:00:00"), 46122, 5, 5, 2);
                for (int i = 1; i < 7; i++)
                {
                ...
                foreach(Pool p in service.AllPools())
                {
        ...
        void addCourses()
        {
            ...
            try
            {
                ...
                Course c = new Course("Learning with M. Phelps", false, Days.Monday | Days.Wednesday | Days.Friday, new TimeSpan(0, 45, 0), new DateTime(2018, 6, 29),
                                       20, 6, 100,  new DateTime(2017, 9, 4),  Convert.ToDateTime("09:30:00"),null);
                service.addCourse(c);
                ...
                // ¡¡¡¡¡¡¡ Assuming that Id is not autogenerated !!!!!!
                ...
                c = new Course("201 - Swimming", false, Days.Monday | Days.Wednesday | Days.Friday,  new TimeSpan(0, 45, 0), new DateTime(2018, 3, 30),
                     20, 6, 100, new DateTime(2018, 1, 6),  Convert.ToDateTime("09:30:00"), null);
                service.addCourse(c);

                // Adding lanes for a Course
                // ¡¡¡¡¡¡¡ Assuming that Id is not autogenerated !!!!!!
                p = service.findPoolById(1);
        ...
        void addMonitor()
        {
            ...
            try
            {
                ...
                Monitor m = new Monitor("SSN01010101", " Michael Phelps'address", "ES891234121234567890", "Michael Phelps", 46001, "X-00000001");
        ...
        void addPayments()
        {
            ...
            try
            {
                ...
                // Testing Payments
                foreach (Enrollment en in service.AllEnrollments())
                {
                ...
                Console.WriteLine("\n  Free Swim payments");
                foreach (Payment p in service.AllFreeSwimPayments())
